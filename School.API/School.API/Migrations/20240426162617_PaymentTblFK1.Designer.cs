...
namespace School.API.Migrations
{
    ...
    [Migration("20240426162617_PaymentTblFK1")]
    partial class PaymentTblFK1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School.API.Core.Entities.Payments", b =>
                {
                    ...
                    b.Property<int>("PaymentAllotment")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.API.Core.Entities.Payments", b =>
                {
                    b.HasOne("School.API.Core.Entities.PaymentAllotment", "paymentAllotment")
                        .WithMany()
                        .HasForeignKey("PaymentAllotment")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("paymentAllotment");
                });
